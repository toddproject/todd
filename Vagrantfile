...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder '.', '/home/vagrant/go/src/github.com/toddproject/todd', nfs: true

  # This is a temporary measure. Once https://github.com/toddproject/todd/issues/72 is addressed, we can go back
